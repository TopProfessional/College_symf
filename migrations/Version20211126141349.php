 ...
 */
final class Version20211126141349 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
       ...
       // $this->addSql('ALTER TABLE student CHANGE user user_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE student CHANGE user_id user INT NOT NULL');
    }
}
